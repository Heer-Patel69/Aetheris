...
from utils import is_safe_path, redact_secrets, initialize_perimeter
...
class ConfigManager:
    def __init__(self, workspace_path):
        ...
        self.global_config_dir = Path("~/.univoid/brain/config").expanduser()
        self.project_config_dir = self.workspace_path / ".univoid/config"

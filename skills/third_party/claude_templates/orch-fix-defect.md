...
description: "Orchestrate fixing a bug \u2014 reproduce it as a failing regression\
  \ test, fix to green, review, and gated commit \u2014 by delegating each phase to\
  \ the matching ECC agent. Use when existing behavior is broken or wrong."
color: slate
emoji: "\U0001F916"

...
description: "Agent-driven scheduling and publishing of social media posts across\
  \ 13 platforms via SocialClaw. Use when the user wants to publish to X, LinkedIn,\
  \ Instagram, Facebook Pages, TikTok, Discord, Telegram, YouTube, Reddit, WordPress,\
  \ or Pinterest \u2014 or when managing campaigns, uploading media, or monitoring\

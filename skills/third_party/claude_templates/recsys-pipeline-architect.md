...
description: "Design composable recommendation, ranking, and feed pipelines using\
  \ the six-stage Source\u2192Hydrator\u2192Filter\u2192Scorer\u2192Selector\u2192\
  SideEffect framework popularized by xAI's open-sourced For You algorithm. Use this\
  \ skill whenever the user is building any system that picks \"the top K items for\
  \ a (user, context)\" \u2014 social feeds, content CMSs, RAG rerankers, task prioritizers,\
  \ notification triage, search reranking, ad ranking."
color: slate
emoji: "\U0001F916"

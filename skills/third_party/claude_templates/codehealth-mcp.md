---
name: codehealth-mcp
description: "Real-time structural Code Health via CodeScene MCP \u2014 review before\
  \ edits, verify score deltas after changes, gate commits and PRs. Use when reviewing\
  \ code quality, refactoring, checking if AI changes degraded a file, or before commit/PR."
color: slate
emoji: "\U0001F916"

---
name: django-celery
description: "Django + Celery async task patterns \u2014 configuration, task design,\
  \ beat scheduling, retries, canvas workflows, monitoring, and testing. Use when\
  \ adding background jobs, scheduled tasks, or async processing to a Django app."
color: slate
emoji: "\U0001F916"

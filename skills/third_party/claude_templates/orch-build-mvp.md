...
description: "Orchestrate bootstrapping a working MVP from a design or spec document\
  \ \u2014 ingest the doc, plan thin vertical slices, scaffold the first end-to-end\
  \ slice, then TDD-implement, review, and gated commit. Use to turn an SDD/PRD into\
  \ a running starting point."
color: slate
emoji: "\U0001F916"

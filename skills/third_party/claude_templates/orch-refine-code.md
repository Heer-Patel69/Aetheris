...
description: "Orchestrate a behavior-preserving refactor \u2014 confirm tests are\
  \ green, restructure without changing behavior, keep tests green, review, and gated\
  \ commit. Use when the structure should improve but behavior must not change."
color: slate
emoji: "\U0001F916"

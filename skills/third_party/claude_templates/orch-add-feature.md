...
description: "Orchestrate building a brand-new feature end to end \u2014 research,\
  \ plan, TDD implementation, review, and gated commit \u2014 by delegating each phase\
  \ to the matching ECC agent. Use when adding a capability that does not exist yet."
color: slate
emoji: "\U0001F916"

...
description: "Legacy-project style inheritance skill. Use when the user types /inherit-legacy-style,\
  ...
  \ need to prevent \"style drift\" (the model imposing its pretrained mainstream\
  \ idioms onto the project). Language- and framework-agnostic \u2014 it aligns meta-architecture\

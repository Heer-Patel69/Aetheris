...
spec_pattern = re.compile(r"^SPEC-1\d{2}-.*\.md$")
...
for spec_file in spec_files:
    ...
    # 1. Verify all 26 sections exist
    missing_sections = []
    for i in range(1, 27):
        section_hdr = f"{i}. "
...
if errors:
    ...
    print("Verification SUCCEEDED! All files conform to the 26-section standard and contain valid schemas.")
    exit(0)

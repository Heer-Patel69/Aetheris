# SPEC-142: Self Decision Engine (SDE)
...
Implementation: `src/evolution/decision.py`
Primary Class: `SelfDecisionEngine`
Test Reference: `tests/test_rfc009_core.py`

======================================================================
1. EXECUTIVE SUMMARY
======================================================================
The Self Decision Engine (SDE) is a core subsystem of the Aetheris Self-Evolution layer. It enables Aetheris to autonomously improve its architecture, engineering process, quality, and operational efficiency while maintaining strict, audit-grade governance and traceability.

======================================================================
2. PRIMARY GOAL
======================================================================
Make optimal system evolution choices, aiming for a 95% decision accuracy rating based on historical feedback.
...
======================================================================
Ensures that system modifications are evaluated systematically rather than applied ad-hoc, preventing chaotic mutations.
...
7. INPUTS
======================================================================
The engine consumes inputs defined by the `SPEC-142Input` schema. Key variables include:
- `request_id`: Unique transaction identifier.
- `spec_id`: The ID of this specification (SPEC-142).
- `payload`: Subsystem parameters.

| Input Source | Format | Purpose |
|---|---|---|
| Architecture review logs, historical success rates, model cost tables. | Structured JSON | Contextual parameters for execution loops |
| Configuration DB | JSON | Credentials, system rules, and timeout parameters |

======================================================================
8. OUTPUTS
======================================================================
The engine produces outputs conforming to the `SPEC-142Output` schema. Outputs include:
...
|---|---|---|
| Signed evolution decisions, strategy reports, decision audit logs. | Markdown/JSON | Workspace directories & EKB objects |
...
======================================================================
Suggested path structure: `src/evolution/decision.py`.
Modules in scope: `engine.py, risk_evaluator.py, decision_selector.py, metrics.py`
...
```python
def evaluate_evolution_options(request_id, candidate_options) -> Dict[str, Any]:
    """
    Public interface for the Self Decision Engine.
...
- `def _score_options(options), _verify_signatures(decision) -> Any`
...
- Analytical Hierarchy Process (AHP) for multi-criteria decision making, risk-utility matrix scoring.
...
Prometheus Counters:
- `aetheris_evolution_runs_total{engine="SDE"}`: Invocations count.
- `aetheris_evolution_duration_ms{engine="SDE"}`: Duration traces.

======================================================================
18. FAILURE RECOVERY
======================================================================
Fallback to conservative defaults; locks active queues; routes alerts to CEO agent.
...
Test Command:
`pytest tests/test_rfc009_core.py -k "SelfDecisionEngine"`
...
21. FUTURE EVOLUTION
======================================================================
Utilize reinforced online learning pipelines to continuously adjust scoring weights.

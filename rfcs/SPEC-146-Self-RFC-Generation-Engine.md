# SPEC-146: Self RFC Generation Engine (SRGE)
...
Implementation: `src/evolution/rfc_gen.py`
Primary Class: `SelfRFCGenerationEngine`
Test Reference: `tests/test_rfc009_core.py`

======================================================================
1. EXECUTIVE SUMMARY
======================================================================
The Self RFC Generation Engine (SRGE) is a core subsystem of the Aetheris Self-Evolution layer. It enables Aetheris to autonomously improve its architecture, engineering process, quality, and operational efficiency while maintaining strict, audit-grade governance and traceability.

======================================================================
2. PRIMARY GOAL
======================================================================
Draft clear, compliant, and standard-aligned RFC drafts for engineering board review.
...
======================================================================
Saves developer time by translating system evolution findings into formal, structured documents.
...
7. INPUTS
======================================================================
The engine consumes inputs defined by the `SPEC-146Input` schema. Key variables include:
- `request_id`: Unique transaction identifier.
- `spec_id`: The ID of this specification (SPEC-146).
- `payload`: Subsystem parameters.

| Input Source | Format | Purpose |
|---|---|---|
| Evolution recommendations, system diagrams, documentation templates. | Structured JSON | Contextual parameters for execution loops |
| Configuration DB | JSON | Credentials, system rules, and timeout parameters |

======================================================================
8. OUTPUTS
======================================================================
The engine produces outputs conforming to the `SPEC-146Output` schema. Outputs include:
...
|---|---|---|
| RFC markdown documents, diagram files, reference directories. | Markdown/JSON | Workspace directories & EKB objects |
...
======================================================================
Suggested path structure: `src/evolution/rfc_gen.py`.
Modules in scope: `engine.py, doc_builder.py, diagram_generator.py, metrics.py`
...
```python
def generate_rfc_draft(request_id, proposal_data) -> Dict[str, Any]:
    """
    Public interface for the Self RFC Generation Engine.
...
- `def _build_sections(data), _verify_document_links(doc) -> Any`
...
- Template rendering, structured text processing, link graph verification.
...
Prometheus Counters:
- `aetheris_evolution_runs_total{engine="SRGE"}`: Invocations count.
- `aetheris_evolution_duration_ms{engine="SRGE"}`: Duration traces.

======================================================================
18. FAILURE RECOVERY
======================================================================
Discards corrupt drafts; logs formatting details to writer EKB.
...
Test Command:
`pytest tests/test_rfc009_core.py -k "SelfRFCGenerationEngine"`
...
21. FUTURE EVOLUTION
======================================================================
Generate interactive visual diagrams dynamically from codebase changes.

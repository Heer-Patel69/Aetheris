# SPEC-116: Administrative Control Panel (Admin API) (ACPA)
...
Primary Class: `AdminAPIOrchestrator`
Test Reference: `tests/test_rfc007_core.py`

======================================================================
1. PURPOSE & BUSINESS VALUE
======================================================================
The Administrative Control Panel (Admin API) (ACPA) exists to provide a foundational enterprise capability for Aetheris. It ensures secure, production-scale, multi-tenant operations, maintaining compliance, security boundaries, and strict resource isolation.
...
======================================================================
- FR-101: The engine shall load configurations conforming to the `SPEC-116Input` schema.
- FR-102: The engine shall authorize all operations against tenant context parameters.
- FR-103: The engine shall execute the core `AdminAPIOrchestrator` behaviors.
- FR-104: The engine shall output structured results conforming to the `SPEC-116Output` schema.
...
======================================================================
Primary Path: `src/enterprise/admin_api.py`.
The class `AdminAPIOrchestrator` acts as the main domain service layer, validating API structures, interacting with local storage adapters, and dispatching transaction logs to the audit service.
...
- `AdminAPIOrchestratorCore`: Executes subsystem transformations.
...
3. Call `AdminAPIOrchestrator` core behaviors.
...
======================================================================
Primary logic is defined in `src/enterprise/admin_api.py`. Sub-modules handle encryption, parsing, and database schemas.
...
|---|---|---|
| `suspend_tenant(tenant_id: str, reason: str) -> bool` | Suspends all active pipelines and portal access for the specified tenant. | Validate input, enforce security boundaries, return deterministic output, and emit telemetry. |
...
18. OBSERVABILITY
======================================================================
Structured logging includes standard event codes like `ACPA_STARTED`, `ACPA_SUCCESS`, and `ACPA_FAILED` with request ID attributes.

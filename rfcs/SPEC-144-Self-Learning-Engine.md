# SPEC-144: Self Learning Engine (SLE2)
...
Implementation: `src/evolution/learning.py`
Primary Class: `SelfLearningEngine`
Test Reference: `tests/test_rfc009_core.py`

======================================================================
1. EXECUTIVE SUMMARY
======================================================================
The Self Learning Engine (SLE2) is a core subsystem of the Aetheris Self-Evolution layer. It enables Aetheris to autonomously improve its architecture, engineering process, quality, and operational efficiency while maintaining strict, audit-grade governance and traceability.

======================================================================
2. PRIMARY GOAL
======================================================================
Optimize prompt templates and skill selections to reduce token use and agent task retries.
...
======================================================================
Reduces model errors and token wastes by dynamically updating system prompts from historical logs.
...
7. INPUTS
======================================================================
The engine consumes inputs defined by the `SPEC-144Input` schema. Key variables include:
- `request_id`: Unique transaction identifier.
- `spec_id`: The ID of this specification (SPEC-144).
- `payload`: Subsystem parameters.

| Input Source | Format | Purpose |
|---|---|---|
| Agent completion logs, token counts logs, prompt template files. | Structured JSON | Contextual parameters for execution loops |
| Configuration DB | JSON | Credentials, system rules, and timeout parameters |

======================================================================
8. OUTPUTS
======================================================================
The engine produces outputs conforming to the `SPEC-144Output` schema. Outputs include:
...
|---|---|---|
| Updated prompt templates, skill routing updates, training reports. | Markdown/JSON | Workspace directories & EKB objects |
...
======================================================================
Suggested path structure: `src/evolution/learning.py`.
Modules in scope: `engine.py, prompt_ranker.py, skill_updater.py, metrics.py`
...
```python
def optimize_prompts_and_skills(request_id, performance_logs) -> Dict[str, Any]:
    """
    Public interface for the Self Learning Engine.
...
- `def _evaluate_responses(logs), _update_prompt_templates(templates) -> Any`
...
- Genetic algorithms for prompt optimization, Bayesian routing for skills.
...
Prometheus Counters:
- `aetheris_evolution_runs_total{engine="SLE2"}`: Invocations count.
- `aetheris_evolution_duration_ms{engine="SLE2"}`: Duration traces.

======================================================================
18. FAILURE RECOVERY
======================================================================
Reverts to default template baseline; notifies CTO Agent of template verification errors.
...
Test Command:
`pytest tests/test_rfc009_core.py -k "SelfLearningEngine"`
...
21. FUTURE EVOLUTION
======================================================================
Support automated few-shot example generation using verified success stories.

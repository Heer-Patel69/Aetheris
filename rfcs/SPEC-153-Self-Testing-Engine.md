# SPEC-153: Self Testing Engine (STE2)
...
Implementation: `src/evolution/testing.py`
Primary Class: `SelfTestingEngine`
Test Reference: `tests/test_rfc009_core.py`

======================================================================
1. EXECUTIVE SUMMARY
======================================================================
The Self Testing Engine (STE2) is a core subsystem of the Aetheris Self-Evolution layer. It enables Aetheris to autonomously improve its architecture, engineering process, quality, and operational efficiency while maintaining strict, audit-grade governance and traceability.

======================================================================
2. PRIMARY GOAL
======================================================================
Validate all system updates before deployment, ensuring zero critical regression leaks.
...
======================================================================
Prevents faulty self-mutated code from reaching execution pipelines by validating updates.
...
7. INPUTS
======================================================================
The engine consumes inputs defined by the `SPEC-153Input` schema. Key variables include:
- `request_id`: Unique transaction identifier.
- `spec_id`: The ID of this specification (SPEC-153).
- `payload`: Subsystem parameters.

| Input Source | Format | Purpose |
|---|---|---|
| Test definitions, system update packages, validation criteria. | Structured JSON | Contextual parameters for execution loops |
| Configuration DB | JSON | Credentials, system rules, and timeout parameters |

======================================================================
8. OUTPUTS
======================================================================
The engine produces outputs conforming to the `SPEC-153Output` schema. Outputs include:
...
|---|---|---|
| Test pass summaries, regression reports, system health statuses. | Markdown/JSON | Workspace directories & EKB objects |
...
======================================================================
Suggested path structure: `src/evolution/testing.py`.
Modules in scope: `engine.py, test_runner.py, schema_checker.py, metrics.py`
...
```python
def run_system_tests(request_id, update_pkg) -> Dict[str, Any]:
    """
    Public interface for the Self Testing Engine.
...
- `def _run_pytest(suite), _verify_schemas(schemas) -> Any`
...
- Test case selection prioritization, AST validation rules.
...
Prometheus Counters:
- `aetheris_evolution_runs_total{engine="STE2"}`: Invocations count.
- `aetheris_evolution_duration_ms{engine="STE2"}`: Duration traces.

======================================================================
18. FAILURE RECOVERY
======================================================================
Halts deployment pipeline; reverts update packages; alerts CTO Agent.
...
Test Command:
`pytest tests/test_rfc009_core.py -k "SelfTestingEngine"`
...
21. FUTURE EVOLUTION
======================================================================
Implement dynamic test suite generation based on API path changes.
